...
struct ComicSidebarView: View {
    @Binding var isOpen: Bool
    @Binding var activeSection: ComicSection
        ...
        ZStack(alignment: .trailing) {
            ...
            HStack(spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    ForEach(ComicSection.allCases, id: \.self) { section in
                        sidebarRow(section)
                    }
    ...
    private func sidebarRow(_ section: ComicSection) -> some View {
        Button {
